 ...
 * 他们有许多共同点: 都含有user / createdAt /lastUpdatedAt 属性
 */
public interface QueryHQLInterface {

    String getHQLby
            (String tableName , WherePara wherePara  , long...args);

    String getHQLby
            (String tableName , WherePara wherePara  ,String...args);


    String getHQLby
            (String tableName , WherePara wherePara , OrderByPara orderByPara , OrderByMethod orderByMethod , long...args);

    String getHQLby
            (String tableName , WherePara wherePara , OrderByPara orderByPara , OrderByMethod  orderByMethod ,String...args);
