...
public class Wiki_httpDAOImplTest {
    ...
    @Test
    public void getWikiByString() throws Exception {
       // String s = "{\"exist\":\"1\",\"data\":{\"title\":\"唐诗宋词原理分享\",\"content\":\"aabbcc\"}}";
      //  String s = "{\"exist\":\"1\",\"data\":{\"title\":\"唐诗宋词原理分享\",\"categories\":[\"他就是爱吃火锅\"],\"currVersionString\":\"0.1\",\"editor\":\"dzm14\",\"visits\":\"6\",\"date\":\"2016-07-18 09:19:04\",\"tags\":[\"Andorra\"],\"content\":\"aabbcc\"}}\n";
        ...
        System.out.println(dao.getWikiByString(s));
    }
